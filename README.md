...
## Франтэнд
Калі асноўная праца на франце, то зручней запусьціць бэкэнд асобна, а фронт ужо запускаць у распрацоўным рэжыме (`Editor/src> npm run dev`), і даступацца да яго праз http://localhost:3000.
