...
const genreOptions = [
  { value: 'падкаст', label: 'Падкаст' },
  { value: 'навуковы артыкул', label: 'Навуковы артыкул' },
  { value: 'інтэрв\'ю', label: 'Інтэрв\'ю' }
];
...
export default function NewDocument() {
  ...
  const handleInputChange = (field: keyof UploadFormData, value: string | number | undefined) => {
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-bold text-gray-900">
                  Дадаць новы дакумэнт
                </h1>
                <p className="mt-1 text-sm text-gray-500">
                  Запоўніце інфармацыю пра дакумэнт і выберыце файл
                </p>
              </div>
              <Link
                href="/"
          ...
          <form onSubmit={handleSubmit} className="px-6 py-6 space-y-6">
            ...
            <div className="flex justify-end space-x-3 pt-6 border-t border-gray-200">
              ...
              >
                {loading ? 'Загрузка...' : 'Загрузіць дакумэнт'}
              </button>
            </div>
          </form>
        </div>
